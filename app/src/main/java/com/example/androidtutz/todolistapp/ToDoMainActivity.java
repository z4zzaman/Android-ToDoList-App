...
public class ToDoMainActivity extends AppCompatActivity implements TodolistFragment.OnFragmentInteractionListener, UpdateToDoFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.my_to_do));
        ...
        final ToDoPagerAdapter adapter = new ToDoPagerAdapter(getSupportFragmentManager(), todoTabs.getTabCount());
